...
const APP_ICONS = {
  cartEmpty: ICON_BASE + 'cart-empty.png',
  cartFull: ICON_BASE + 'cart-full.png',
  list: ICON_BASE + 'mode-list.png',
  recipes: ICON_BASE + 'mode-recipes.png',
  products: ICON_BASE + 'mode-products.png',
};
    ...
    function Header({
      ...
      function TabIcon({ type, active = false }) {
        const src = APP_ICONS[type] || APP_ICONS.list;
        return (
          <img
            src={src}
            alt=""
                    ...
                    <div className="px-3 py-3 border-b border-slate-100">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <div
                            className="mt-0.5 text-[11px] font-medium text-slate-500 truncate"
                            title={`Versie ${APP_VERSION}, build ${APP_COMMIT}`}
                          >
                            v{APP_VERSION} · build {APP_COMMIT}
                          </div>
                          <HouseholdNameLine />
                        </div>
